...
(async () => {
  ...
  console.log("M1: 91 scenario JSON files present and parse");
  {
    ...
    check("M1 exactly 91 scenario files",
      files.length === 91,
      "found " + files.length);
    ...
    check("M1 all expected IDs present (S01–S91)", allIds,
  ...
  console.log("\nM4: runScenarios returns stable report schema");
  {
    ...
    check("M4 report has 91 scenarios",
      Array.isArray(report.scenarios) && report.scenarios.length === 91,
