...
async function run() {
  ...
  // ── S1 — Default registry loads and reports 54 tools ─────────────────────
  console.log("S1: Default registry loads with 54 tools");
  ...
  }
  {
    ...
    check("S1 total tools == 54", summary.total === 54, "got " + summary.total);
  }
